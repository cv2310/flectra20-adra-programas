...
class ReportXlsGeneralLedger(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, objs):
        ...
        if p_data['x_document_type'] == 'BANCO' and p_data['x_report_type'] == 'cuenta':
            ...
            worksheet.insert_image('A3', logo_path_adra, {'x_scale': 0.5, 'y_scale': 0.5, 'y_offset': 7})
            worksheet.insert_image('B3', logo_path_mejornines, {'x_scale': 0.5, 'y_scale': 0.5, 'x_offset': -50})
